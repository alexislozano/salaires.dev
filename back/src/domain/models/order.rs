...
impl<K> Default for Order<K> where K: Default {
    fn default() -> Self {
        Self { key: K::default(), direction: Direction::default() }
    }
}

impl<K> From<HashMap<String, String>> for Order<K> where K: Default + From<String> {
